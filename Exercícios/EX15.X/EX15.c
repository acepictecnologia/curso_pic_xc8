...
int T0_10s = 0;                 //Variável de controle do tempo em 10s
int conta5s = 0, conta10s = 0;  //Variáveis de contagem
char bufferLCD[16];             //Matriz de armazenamento da string para o LCD
