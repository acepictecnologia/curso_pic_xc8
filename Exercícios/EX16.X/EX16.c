...
int T0_500ms = 0, T1_1000ms = 0; //Variáveis pra controle dos tempos de 500ms e 1000ms
int conta_t0 = 0, conta_t1 = 0;     //Variáveis de contagem
char bufferLCD[16];             //Matriz para armazenamento da string para o LCD

//Função de tratamento para Int. do TIMER0 e Timer1
...
void main(void) {
    ...
    TMR1H = 0x0B;           //Valor inicial para os registrados de contagem
    TMR1L = 0xDC;           //do módulo TIMER1 - equivalente a 3036
