...
int T0_1000;                //Variável de contagem do tempo 1 segundo
     ...
     if (T0_1000 >= 40)		    //Se T0_500 >= 20 (500ms)
        {
            ...
            if (conta>=1000) conta = 0;      //Se conta >= 1000, zera a variável
...
void main(void) {
    ...
    PORTBbits.RB0 = 0;      //Atribui nível 0 ao pino 0 da porta B
