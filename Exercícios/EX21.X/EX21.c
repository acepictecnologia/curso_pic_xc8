...
#include "../Bibliotecas/LCD4bits.h"		//Inclusão do arquivo LCD4b.h

#define _XTAL_FREQ 8000000		//Define a frequência de clock utilizada

int adc = 0;
long volt = 0;              //Variável de armazenamento da tensão (AN1)
float temp = 0;             //Variável de armazenamento da temperatura (AN0))
...
void main(void) {
    ...
    while(1){
        ...
        ADCON0 = 0b00000001; //Seleciona o canal AN0 para leitura 
        ...
        adc = ADRESH;           //Armazena a parta alta do resultado em adc
        ...
        volt = ((long)adc * 5000) / 1023;   //Converte adc em tensão
